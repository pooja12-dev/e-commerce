  ...
  return (
    <>
      <header className="w-full hidden lg:flex md:hidden h-20 uppercase bg-transparent hover:bg-white sticky top-0 z-50">
        ...
        {isMenuOpen && <ShopMenu />}
        {isBagMenuOpen && <ShoppingBag itemCount={bagCount} />}
      </header>
      {/* Hidden on small and middle */}

      {/*hidden on small and middle*/}
      <header
        className=" lg:hidden md:hidden text-gray-600 w-full py-4 px-6 bg-none sm:sticky sm:top-0 sm:z-50"
        style={{
          position: "sticky",
          top: "0 !important",
          zIndex: "50 !important",
      ...
      <header className="w-full hidden md:flex lg:hidden h-20 uppercase bg-transparent border-b border-gray-200 md:sticky md:top-0 md:z-50">
