    ...
    <>
      <header className="w-full hidden lg:flex md:hidden h-20 uppercase !bg-transparent hover:bg-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between py-6 px-4 md:px-8 w-full">
          ...
          {/* Mobile Menu Toggle - Hidden on md/lg */}
          <button
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute top-20 left-0 w-full bg-white z-40 transition-transform duration-300 ${
            isMobileMenuOpen ? "block" : "hidden"
          }`}
        >
          <nav className="flex flex-col gap-5 text-xs md:text-sm font-serif p-4">
